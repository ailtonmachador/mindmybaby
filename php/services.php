    ...
    <body data-spy="scroll" data-target=".navbar">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mobile">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="services.php"><span class="glyphicon glyphicon-heart-empty"></span> Services</a></li>
                        <li><a href="../registration.html"><span class="glyphicon glyphicon-education"></span> Register child</a></li>
                        <li><a href="../testimonial_add_or_show.html"><span class="glyphicon glyphicon-stats"></span> Testemonials</a></li>
        ...
        <div id="section3" class="container-fluid">
            ...
            <div class="offers">
               ...
               <h4> <textarea disabled  rows=25 cols=7  style="width:500px; height: 280px;"> <?php echo "$event_text_body" ?>    </textarea>                                         
                </h4>
