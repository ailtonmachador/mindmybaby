...
require("connection.php");
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $displayed = 'no';            //by default all comments will hold 'no' as values, once the adm has to approve comments
    $errors = array();
...
//      $run = mysqli_query($db_c,$query);
      ...
      $vin =  pass_input($_POST['firstname']);
    ...
    //-----end cod testimonial------------------------------
        ...
        if( empty($errors)){
          $query2 = "INSERT INTO parent_testimonial(cod_testimonial, services, days_date, firstname, comment, email, displayed )
          VALUES('$cod_testimonial', '$service','$days_date','$firstname','$comment', '$email', '$displayed' )";
   
         $run2 = mysqli_query($db_c,$query2);
          echo "Thank you for giving your feedback, redirecting page...";      
